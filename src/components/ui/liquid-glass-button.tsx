  ...
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cool: "bg-gradient-to-t border border-b-2 border-black/40 from-cyan-500 to-cyan-400 shadow-md shadow-cyan-500/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 text-black",
        outline:
          "border border-cyan-500/50 bg-transparent hover:bg-cyan-500/10 hover:text-cyan-400",
        secondary:
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-cyan-400",
        destructive:
          "bg-red-500 text-white hover:bg-red-500/90",
        outline:
          "border border-cyan-500/50 bg-transparent hover:bg-cyan-500/10 hover:text-cyan-400",
    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            shadow-[0_0_8px_rgba(34,211,238,0.2),0_2px_6px_rgba(0,0,0,0.4),inset_3px_3px_0.5px_-3.5px_rgba(255,255,255,0.09),inset_-3px_-3px_0.5px_-3.5px_rgba(255,255,255,0.2),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.2),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.2),inset_0_0_6px_6px_rgba(34,211,238,0.12),inset_0_0_2px_2px_rgba(34,211,238,0.06),0_0_12px_rgba(34,211,238,0.15)] 
        transition-all" />
        <div
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#22D3EE]",
    inner: "bg-gradient-to-b from-[#0891b2] via-[#0e7490] to-[#164e63]",
    button: "bg-gradient-to-b from-[#06b6d4] to-[#0891b2]/40",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(8_145_178_/_100%)]",
  },
  success: {
